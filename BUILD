...
envoy_cc_library(
    name = "pkm_provider",
    srcs = ["pkm_provider.cc", "pkm_provider_tss.cc", "tpm/tpm_key.cc", "tpm/tpm_privkey_operator.cc", "util.cc"],
    hdrs = ["pkm_provider.h", "pkm_provider_tss.h", "tpm/tpm_key.h", "tpm/tpm_privkey_operator.h", "util.h"],
    repository = "@envoy",
    deps = [
